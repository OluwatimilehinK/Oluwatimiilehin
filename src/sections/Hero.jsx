    ...
    <section className='relative min-h-screen flex items-center overloww-hidden'>
      ...
      <div className='absolute inset-0'>
        ...
        {[...Array(30)].map((_, index) => (
          <div
            key={index}
            className='absolute w-1.5 h-1.5  rounded-full opacitiy-60 '
            style={{
          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            ...
            <div className="animate-fade-in">
              ...
              <div className="space-y-4">
                ...
                <p className='text-muted-foreground mt-4 max-w-lg animate-fade-in animation-delay-200 text-lg'>
