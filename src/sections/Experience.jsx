    ...
    <section id="experience" className="py-16 sm:py-24 lg:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="relative">
          <div className="timeline-glow absolute left-2 md:left-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-primary/70 via-primary/30 to-transparent md:-translate-x-1/2 shadow-[0_0_25px_rgba(32,178,166,0.8)]" />
          ...
          <div className="space-y-10 sm:space-y-12">
            {experiences.map((exp, idx) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="absolute left-2 md:left-1/2 top-0 w-3 h-3 bg-primary rounded-full -translate-x-1/2 ring-4 ring-background z-10">
                  {exp.current && (
